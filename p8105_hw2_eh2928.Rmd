...
Note that there are `r nrow(distinct(transit_df, line, station_name))` distinct stations (by line and station_name combination). Only `r of the `r nrow(distinct(transit_df, line, station_name))` distinct stations are ADA compliant. 
