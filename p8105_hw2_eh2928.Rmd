...
Each dataset is organized by month and year. The "pols-month" dataset contains 10 variables that relate the number of Democratic and Republican politicians in power (seated in the governorship, House of Representatives, Senators, and presidency), and it contains `r nrow(pols_month_df)` rows, and `r ncol(pols_month_df)` columns. The "snp" dataset shows the S&P index at closing
